...
class CustomParts(DatasetTemplate):
    ...
    def include_data(self, mode):
        self.logger.info('Loading CustomParts dataset.')
        custom_infos = []
        ...
        self.logger.info('Total samples for CUSTOM_PARTS dataset: %d' % (len(custom_infos)))
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_custom_infos':
        ...
        create_custom_infos(
            ...
            class_names=['part1', 'part2', 'clamp', 'glove'],
            data_path=ROOT_DIR / 'data' / 'custom_parts',
            save_path=ROOT_DIR / 'data' / 'custom_parts',
        )
